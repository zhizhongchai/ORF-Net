...
class UnlabelOutput(nn.Module):
    def __init__(self, cfg):
        super(UnlabelOutput, self).__init__()
    ...
    def compute_targets_for_locations(self, locations, targets, size_ranges, num_loc_list):
        ...
        for im_i in range(len(targets)):
            ...
            # scores_per_im = targets_per_im.scores
            ...
            # scores_per_im = scores_per_im[locations_to_gt_inds]
            # scores_per_im[locations_to_min_area == INF] = self.num_classes
    ...
    def losses(self, logits_pred, locations, gt_instances, logits_box, branch, logits_dot=None):
        """
        ...
        return self.fcos_losses(instances, training_targets, branch)

    def fcos_losses(self, instances, training_targets, branch):
        losses, extras = {}, {}
        train_info = dict()
        ...
        # )
        #
        # class_loss = torch.sum(class_loss * loss_weight)
