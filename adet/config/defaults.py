...
_C.SOLVER.IMG_PER_BATCH_NEG = 4
_C.SOLVER.IMG_PER_BATCH_BOX = 4
_C.SOLVER.IMG_PER_BATCH_DOT = 4
_C.SOLVER.IMG_PER_BATCH_MASK = 4

_C.DATASETS.TRAIN_BOX = ()
_C.DATASETS.TRAIN_DOT = ()
_C.DATASETS.TRAIN_MASK = ()
...
_C.MODEL.FCOS.TOPK = 5
_C.MODEL.FCOS.WEIGHT_LOSS = False
...
_C.MODEL.FCOS.CENTER_ATTN = False
_C.MODEL.FCOS.BOX_ATTN = False
_C.MODEL.FCOS.DA = False

_C.MODEL.OMNI = CN()

_C.MODEL.OMNI.BOX_DATA = True
_C.MODEL.OMNI.DOT_DATA = False
_C.MODEL.OMNI.MASK_DATA = False
_C.MODEL.OMNI.UNLABEL_DATA = False
_C.MODEL.OMNI.NEG_DATA = True

_C.MODEL.OMNI.BOX_ON = True
_C.MODEL.OMNI.DOT_ON = False
_C.MODEL.OMNI.UNLABEL_ON = False
_C.MODEL.OMNI.MASK_ON = False

_C.MODEL.OMNI.BOX_WEIGHT_ON = True
_C.MODEL.OMNI.DOT_WEIGHT_ON = True
...
_C.MODEL.CENTERNET.NUM_BOX_CONVS = 1
...
# _C.MODEL.CENTERNET.HM_FOCAL_ALPHA = 0.1
...
_C.MODEL.CENTERNET.IGNORE_HIGH_FP = 0.85
_C.MODEL.CENTERNET.MORE_POS = True
...
_C.MODEL.BASIS_MODULE.LOSS_WEIGHT = 1
